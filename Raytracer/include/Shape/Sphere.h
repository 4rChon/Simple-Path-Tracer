...
class Sphere : public IShape {
  ...
  public:
    ...
    {
        return 4.f * std::numbers::pi_v<float> * r2_;
    }
    ...
    {
        return std::numbers::pi_v<float> * r2_;
    }
    glm::vec3 sample_surface(const std::vector<float>& xi) const;
    glm::vec3 sample_facing_surface(const float x0, const float x1,
                                    const glm::vec3& N) const;
    glm::vec3 sample_cosine_weighted_facing_surface(const float x0, const float x1,
                                                    const glm::vec3& N) const;
};
} // namespace Raytracer